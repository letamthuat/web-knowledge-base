...
export function AudioRecordingPillFloating() {
  ...
  return (
    <>
      {isActive && (
        <div
          className={`md:hidden fixed bottom-20 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 rounded-full px-4 py-2.5 font-medium select-none shadow-lg transition-colors ${
