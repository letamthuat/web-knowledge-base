...
export function ReadingHistoryPopover({ docId, onJump }: Props) {
  ...
  return (
    <Popover>
      <PopoverTrigger className="inline-flex h-10 w-10 items-center justify-center rounded-md text-sm hover:bg-accent hover:text-accent-foreground" title="Lịch sử đọc">
