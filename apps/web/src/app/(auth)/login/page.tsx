...
export default function LoginPage() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      // Redirect xử lý bởi Better Auth — không cần push route
    } catch {
      toast.error(E.googleFailed);
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        {/* Divider */}
        <div className="flex items-center gap-3" role="separator" aria-label={L.orDivider}>
...
// Google logo SVG (không dùng external URL — CSP strict NFR14)
function GoogleIcon() {
  return (
    <svg
